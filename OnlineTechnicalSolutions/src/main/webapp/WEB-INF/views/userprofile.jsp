        ...
        <div class="client_area">
            <div class="client_section animated  fadeInUp wow">
                <div class="client_profile">
                    <div  class="client_profile_pic" align="center"><img src="${SITE_URL}/assets/img/client-pic1.jpg" alt="" align=""></div>
                ...
                <div class="quote_section">
                    ...
                    <p><b>
                            ...
                            <div>
                                ...
                                ${technician.addedDate}
                            </div>
                            <div>
                                <label>Last Modified:</label>
                                ${technician.modifiedDate}
                            </div>
                            <div>
                                <label>Status:</label>
                                <c:choose>
                                <c:when test="${technician.status}">
                ...
                <div class="btn btn-lg" >
                    <a href="${SITE_URL}/technician/edit/${technician.id}">
                    <button class="btn btn-success">Edit Your Information</button>
