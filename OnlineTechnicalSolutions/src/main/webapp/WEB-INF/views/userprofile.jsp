...
<div class="client_area">
    <div class="client_section animated  fadeInUp wow">
        <div class="client_profile">
            <div  class="client_profile_pic" align="center"><img src="${SITE_URL}/assets/img/client-pic1.jpg" alt="" align="middle"></div>
        <h3>Saul Goodman</h3>
        <span>Lawless Inc</span> </div>
<!--      <div class="quote_section">-->
<!--        <div class="quote_arrow"></div>-->
<p><b><img src="${SITE_URL}/assets/img/quote_sign_left.png" alt=""></b> 
<!--      </div>-->
      <div class="clear"></div>
    </div>
